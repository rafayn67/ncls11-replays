...
"[project]/NCL/NCLS11/lib/supabase.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/NCL/NCLS11/lib/supabase.ts [app-route] (ecmascript)");
;
;
async function GET(req) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").list(`d${division}/w${week}`);
...
async function POST(req) {
    ...
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").upload(filePath, file.stream(), {
        upsert: true
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffecdfaf._.js.map