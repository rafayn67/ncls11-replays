...
"[project]/NCL/NCLS11/lib/supabase.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY);
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/NCL/NCLS11/lib/supabase.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const UploadReplay = ()=>{
    ...
    const handleUpload = async ()=>{
        ...
        const { data: existsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").list(`d${division}/w${week}`, {
            search: filename
        });
        ...
        if (alreadyExists) {
            ...
            if (!ok) return;
            // Remove old file
            await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").remove([
                path
            ]);
        }
        // Upload file
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").upload(path, file, {
            cacheControl: "3600",
            upsert: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a53ea0c2._.js.map