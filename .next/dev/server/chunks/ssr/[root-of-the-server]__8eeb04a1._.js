...
const UploadReplay = ()=>{
    ...
    const handleUpload = async ()=>{
        ...
        const { data: existsData1 } = await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").list(`d${division}/w${week}`, {
            search: filename1
        });
        // Search for the swapped combination
        const { data: existsData2 } = await __TURBOPACK__imported__module__$5b$project$5d2f$NCL$2f$NCLS11$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("replays").list(`d${division}/w${week}`, {
            search: filename2
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8eeb04a1._.js.map